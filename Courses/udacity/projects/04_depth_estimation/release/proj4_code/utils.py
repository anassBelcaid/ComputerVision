...
def generate_random_stereogram(im_size: Tuple[int, int, int] = (51, 51, 3), disparity: int = 4) -> torch.Tensor:
  ...
  #3 move center by disparity value
  Hc, Wc = H//2, W//2
  im_right[Hc-Hc//2: Hc +Hc//2, Wc-Wc//2-disparity:Wc+Wc//2-disparity]\
    =im_right[Hc-Hc//2:Hc+Hc//2, Wc-Wc//2: Wc + Wc//2]
